...
/**
 *  printa na tela todas as propostas já cadastradas
 *  propostas array de propostas que será percorrido 
*/
...
/**
 * printa somentes propostas que não são ordens de serviço
 *  propostas array de propostas que será verificado
 */ 
...
/**
 *  printa na tela todas as ordens de serviços já cadastradas
 *  ordens array de ordens de serviços que será verificado
 */
...
/**
 *  printa na tela somente propostas que não foram 
...
/**
 *  permite o usuário cadastrar uma nova Proposta
 *  propostas referência do array de propostas que
 * receberá o novo cadastro
 *  numPropostaAtual inteiro que indica qual foi 
...
/**
 *  permite ao usuário cadastrar uma nova ordem de serviço
 *  ordens referência do array de ordens de serviço
 * que receberá o novo Cadastro
 *  propostas array de propostas já cadastradas
 *  numOrdemAtual indica qual foi o número da 
...
/**
 *  indica quantas tarefas foram atribuídas a determinado Engenheiro
 *  engenheiros array de Engenheiro que será percorrido
 *  id número para identificar o engenheiro alvo
 */
...
/**
 *  atribui uma ordem de serviço como tarefa a um Engenheiro
 *  ordens array de referência de ordens de serviço
 *  engenheiros array de referência de Engenheiro
 *  idEng número de identificação do Engenheiro alvo
 */
...
/**
 *  encerra uma ordem de serviço de um engenheiro
 *  engenheiros array de referência de Engenheiro
 *  idEng indica qual a identificação do Engenheiro alvo
 */
...
/**
 *  printa todas as tarefas atribuídas a determinado Engenheiro
 *  engenheiros array de referência de Engenheiro
 *  idEng indica o id do engenheiro alvo
 */
...
/**
 *  printa as informações de um Engenheiro
 *  engenheiros array de referência de Engenheiro
 *  idEng indica o id do engenheiro alvo
 */
...
/**
 *  imprime propostas de determinado Orçamentista
 * que não são ordens de serviço
 *  orcamentistas array de referência de Orçamentista
 ...
 *  orcamentistas array de referencia de Orcamentista
 *  idOrcam indica o id do orçamentista alvo
 */
...
/**
 *  atribui uma determinada proposta a um orçamentista
 *  orcamentistas array de referência de Orçamentista
 *  propostas array de referência de Proposta
 * idOrcam indica o id do orçamentista alvo
 */
...
/**
 *  exibe o progresso da meta estipulada de um 
...
/**
 *  printa as informações de um orçamentista
 *  orcamentistas array de referência de Orçamentista
 * @idOrcam indica o id do orçamentista alvo
 */
...
/**
 *  printa a situação de pagamento de determinada
 * ordem de serviço
 *  ct1 contador que tem acesso às funções
 * relacionadas a faturas e pagamentos
 *  ordensAtuais array de referência de todas as 
...
/**
 *  efetua o pagamento de uma ordem de serviço
 *  ct1 contador que tem acesso às funções
 * relacionadas a faturas e pagamentos
 *  ordensAtuais array de referência de todas as 
 * ordens de serviço atualmente cadastradas
...
/**
 *  função responsável pela parada do programa
...
/**
 *  printa no terminal o menu de cadastros e suas opções
 *  propostasAtuais array de referência de Proposta
 * que guardara uma nova Proposta cadastrada
 *  ordensAtuais array de referência de OrdemServico
 * que guardará uma nova OrdemServico
 *  numOrdemAtual indica qual o número da última
 * ordem cadastrada
 *  numPropostaAtual indica qual o número da 
...
/**
 *  abre no terminal o menu do Engenheiro e suas opções
 *  engenheiros array de Engenheiro
 *  ordensAtuais array que guarda as ordens de serviço
 * cadastradas
 */
...
/**
 *  printa no terminal o menu do Contador e suas opções
 *  ct1 contador responsável pelas funções
 * relacionada a faturas e pagamentos
 *  ordensAtuais array de OrdemServico cadastradas
 */
...
/**
 *  printa no terminal o menu do Orcamentista e suas opções
 *  orcamentistas array de Orcamentista
 *  propostasAtuais array de Proposta que foram cadastradas
 */
...
int main(){
    ...
    Engenheiro* eg1 = new Engenheiro("Gabriel", 3, 20, 7000);
    Engenheiro* eg2 = new Engenheiro("Luis", 4, 30, 10000);
    Engenheiro* eg3 = new Engenheiro("Pedro", 5, 25, 8000);
    
    Orcamentista* oc1 = new Orcamentista("Tofanelli", 1, 19, 3000, 150000);
    Orcamentista* oc2 = new Orcamentista("Breno", 2, 20, 4000, 200000);
    ...
    Contador* ct1 = new Contador("Vinicius", 6, 40, 5000, ordensAtuais);
